...
<svg version="1.1" id="Lager_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
	 viewBox="0 0 619.2 513" style="enable-background:new 0 0 619.2 513;width: 3em;height: 3em;margin-right: 1em;" xml:space="preserve">
<style type="text/css">
	.st0{fill:#FFFFFF;}
	.st1{fill:none;}
</style>
...
export const PrimaryButton = (text: string, onClick: Function) => {
  ...
  component.innerHTML = `${bankIDLogo} ${text}`;
